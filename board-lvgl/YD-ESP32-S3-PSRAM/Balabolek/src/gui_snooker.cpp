...
static lv_obj_t* ui_NLabelHome;
static lv_obj_t* ui_NLabelRefresh;
static lv_obj_t* ui_NRestYellow;
static lv_obj_t* ui_NRestGreen;
static lv_obj_t* ui_NRestBrown;
static lv_obj_t* ui_NRestBlue;
static lv_obj_t* ui_NRestPink;
static lv_obj_t* ui_NRestBlack;
static lv_obj_t* ui_NRestRed;
static lv_obj_t* ui_NLabelRestRed;
static lv_obj_t* ui_NLabelRestScore;
static lv_obj_t* ui_NPanelPly1;
static lv_obj_t* ui_NPlyLabelName1;
static lv_obj_t* ui_NPlyLabelScore1;
static lv_obj_t* ui_NPlyLabelMaxScore1;
static lv_obj_t* ui_NPlyLabelDiff1;
static lv_obj_t* ui_NPanelPlyBreak;
static lv_obj_t* ui_NLabelPlyBreak;
static lv_obj_t* ui_NPanelPly2;
static lv_obj_t* ui_NPlyLabelName2;
static lv_obj_t* ui_NPlyLabelScore2;
static lv_obj_t* ui_NPlyLabelMaxScore2;
static lv_obj_t* ui_NPlyLabelDiff2;
static lv_obj_t* ui_NButtonCancel;
static lv_obj_t* ui_NLabelCancel;
static lv_obj_t* ui_MBPanelSnookerReset;
static lv_obj_t* ui_MBLabelSnookerResetQ;
static lv_obj_t* ui_MBBtnSnookerResetYes;
static lv_obj_t* ui_MBLabelSnookerResetYes;
static lv_obj_t* ui_MBBtnSnookerResetNo;
static lv_obj_t* ui_MBLabelSnookerResetNo;
static lv_obj_t* ui_MBPanelSnookerYellow;
static lv_obj_t* ui_MBLabelSnookerYellowQ;
static lv_obj_t* ui_MBBtnSnookerYellowYes;
static lv_obj_t* ui_MBLabelSnookerYellowYes;
static lv_obj_t* ui_MBBtnSnookerYellowNo;
static lv_obj_t* ui_MBLabelSnookerYellowNo;
static lv_obj_t* ui_BPanelBalls;
static lv_obj_t* ui_BButtonRed;
static lv_obj_t* ui_BLabel1;
static lv_obj_t* ui_BButtonBlack;
static lv_obj_t* ui_BLabel7;
static lv_obj_t* ui_BButtonPink;
static lv_obj_t* ui_BLabel6;
static lv_obj_t* ui_BButtonBlue;
static lv_obj_t* ui_BLabel5;
static lv_obj_t* ui_BButtonBrown;
static lv_obj_t* ui_BLabel4;
static lv_obj_t* ui_BButtonGreen;
static lv_obj_t* ui_BLabel3;
static lv_obj_t* ui_BButtonYellow;
static lv_obj_t* ui_BLabel2;
static lv_obj_t* ui_BButtonMiss;
static lv_obj_t* ui_BLabel0;
static lv_obj_t* ui_BButtonFoul;
static lv_obj_t* ui_BLabelFoul;
static lv_obj_t* ui_BButtonFreeBall;
static lv_obj_t* ui_BLabelFreeBall;
static lv_obj_t* ui_BButtonCancel;
static lv_obj_t* ui_BLabelCancel;
static lv_obj_t* ui_BPanelFree;
static lv_obj_t* ui_BButtonRedF;
static lv_obj_t* ui_BLabelFB1;
static lv_obj_t* ui_BButtonYellowF;
static lv_obj_t* ui_BLabelFB2;
static lv_obj_t* ui_BButtonGreenF;
static lv_obj_t* ui_BLabelFB3;
static lv_obj_t* ui_BButtonBrownF;
static lv_obj_t* ui_BLabelFB4;
static lv_obj_t* ui_BButtonBlueF;
static lv_obj_t* ui_BLabelFB5;
static lv_obj_t* ui_BButtonPinkF;
static lv_obj_t* ui_BLabelFB6;
static lv_obj_t* ui_BPanelFoul;
static lv_obj_t* ui_BButtonF4;
static lv_obj_t* ui_BLabelF4;
static lv_obj_t* ui_BButtonF5;
static lv_obj_t* ui_BLabelF5;
static lv_obj_t* ui_BButtonF6;
static lv_obj_t* ui_BLabelF6;
static lv_obj_t* ui_BButtonF7;
static lv_obj_t* ui_BLabelF7;
static lv_obj_t* ui_BButtonF1;
static lv_obj_t* ui_BLabelF1;
...
static GAME_PLAYER_NAME activePlayer;					// player who made last action
...
{
    boardPublishing.snookerPly1Scores = boardPublishing.snookerPly1Handicap;
    boardPublishing.snookerPly2Scores = boardPublishing.snookerPly2Handicap;

    if (boardPublishing.snooker6Red)
    {
        ballsTable =
        {
            .red = 6,
    ...
    for (uint16_t i = 0; i < numberActions; i++)
    {
        ...
        case P2_RED:
            ballsTable.red--;
            boardPublishing.snookerPly2Scores += 1;
            plySeries += "    1\n";
            break;
        case P2_BLACK:
            if (ballsTable.pink == 0) ballsTable.black--;
            boardPublishing.snookerPly2Scores += 7;
            plySeries += "    7\n";
            break;
        case P2_PINK:
            if (ballsTable.blue == 0) ballsTable.pink--;
            boardPublishing.snookerPly2Scores += 6;
            plySeries += "    6\n";
            break;
        case P2_BLUE:
            if (ballsTable.brown == 0) ballsTable.blue--;
            boardPublishing.snookerPly2Scores += 5;
            plySeries += "    5\n";
            break;
        case P2_BROWN:
            if (ballsTable.green == 0) ballsTable.brown--;
            boardPublishing.snookerPly2Scores += 4;
            plySeries += "    4\n";
            break;
        case P2_GREEN:
            if (ballsTable.yellow == 0) ballsTable.green--;
            boardPublishing.snookerPly2Scores += 3;
            plySeries += "    3\n";
            break;
        case P2_YELLOW:
            if (ballsTable.red == 0 && historyActions[i - 1] != P2_RED) ballsTable.yellow--;
            boardPublishing.snookerPly2Scores += 2;
            plySeries += "    2\n";
            break;
        case P2_F_RED:
            boardPublishing.snookerPly2Scores += 1;
    ...
    // Show scores
    lv_label_set_text_fmt(ui_NPlyLabelScore1, "%d", boardPublishing.snookerPly1Scores);
    lv_label_set_text_fmt(ui_NPlyLabelScore2, "%d", boardPublishing.snookerPly2Scores);

    // Calculate differencies
    lv_label_set_text_fmt(ui_NPlyLabelDiff1, "%+d", boardPublishing.snookerPly1Scores - boardPublishing.snookerPly2Scores);
    lv_label_set_text_fmt(ui_NPlyLabelDiff2, "%+d", boardPublishing.snookerPly2Scores - boardPublishing.snookerPly1Scores);

    if (boardPublishing.snookerControlBalls && ballsTable.red >= 0 && ballsTable.yellow >= 0 && ballsTable.green >= 0 && ballsTable.brown >= 0 && ballsTable.blue >= 0 && ballsTable.pink >= 0 && ballsTable.black >= 0)
    {
        ...
        uint16_t ply1Max = boardPublishing.snookerPly1Scores + scoresOnTable;
        uint16_t ply2Max = boardPublishing.snookerPly2Scores + scoresOnTable;
        ...
        if (boardPublishing.snookerPly1Scores + scoresOnTable < boardPublishing.snookerPly2Scores)
        {
            // Show how many snookers are needed
            lv_obj_add_state(ui_NPlyLabelScore1, LV_STATE_USER_1);
            lv_obj_add_state(ui_NPlyLabelMaxScore1, LV_STATE_USER_1);
            lv_label_set_text_fmt(ui_NPlyLabelMaxScore1, "%d", boardPublishing.snookerPly2Scores - ply1Max);       
        } 
        else
        {
            // Show max series
            lv_obj_remove_state(ui_NPlyLabelScore1, LV_STATE_USER_1);
            lv_obj_remove_state(ui_NPlyLabelMaxScore1, LV_STATE_USER_1);
            lv_label_set_text_fmt(ui_NPlyLabelMaxScore1, "%d", ply1Max);       
        }

        if (boardPublishing.snookerPly2Scores + scoresOnTable < boardPublishing.snookerPly1Scores)
        {
            // Show how many snookers are needed
            lv_obj_add_state(ui_NPlyLabelScore2, LV_STATE_USER_1);
            lv_obj_add_state(ui_NPlyLabelMaxScore2, LV_STATE_USER_1);
            lv_label_set_text_fmt(ui_NPlyLabelMaxScore2, "%d", boardPublishing.snookerPly1Scores - ply2Max);       
        } 
        else
        {
            // Show max series
            lv_obj_remove_state(ui_NPlyLabelScore2, LV_STATE_USER_1);
            lv_obj_remove_state(ui_NPlyLabelMaxScore2, LV_STATE_USER_1);
...
static void gui_snooker_pushAction(SNOOKER_ACTION sAction)
{
    ...
    // copy frame scores to TV-scores as well
    boardPublishing.tvFrameScorePly1 = boardPublishing.snookerPly1Scores;
    boardPublishing.tvFrameScorePly2 = boardPublishing.snookerPly2Scores;

    if (sAction != P1_MISS && sAction != P2_MISS && sAction != P_FLUKE_RED)
    {
        gui_publishCurrentState();
        gui_sendTelegaFrameScoreMessage();
        gui_sayFrameResult();
    }
}
...
{
    if (boardPublishing.snookerControlBalls == false) return true;
...
{
    if (boardPublishing.snookerControlBalls == false) return false;
...
static void ui_event_updatePly1Name(lv_obj_t* obj)
{
	...
	lv_label_set_text(ui_NPlyLabelName1, newName);
}
static void ui_event_updatePly2Name(lv_obj_t* obj)
{
	const char* newName = lv_textarea_get_text(obj);
	gui_setPlayerName(PLAYER2, newName);
	lv_label_set_text(ui_NPlyLabelName2, newName);
}
...
static void ui_event_onPlayerPanel(lv_event_t* e)
{
	...
	{
		if(target == ui_NPanelPly1)
		{
			ui_comp_set_callback(ui_NameKeyboard, ui_event_updatePly1Name);
    		lv_textarea_set_text(ui_comp_get_child(ui_NameKeyboard, UI_COMP_NAMEKEYBOARD_NAMETEXTAREA), lv_label_get_text(ui_NPlyLabelName1));
		}
		else if(target == ui_NPanelPly2)
		{
			ui_comp_set_callback(ui_NameKeyboard, ui_event_updatePly2Name);
    		lv_textarea_set_text(ui_comp_get_child(ui_NameKeyboard, UI_COMP_NAMEKEYBOARD_NAMETEXTAREA), lv_label_get_text(ui_NPlyLabelName2));
		}
		else
		{
...
static void ui_event_MB_ResetYes(lv_event_t* e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        gui_publishCurrentState();
        gui_sendTelegaFrameScoreMessage(false);
        gui_sayFrameResult();
...
static void ui_event_ScreenSnooker(lv_event_t* e)
{
    ...
    {
        lv_label_set_text(ui_NPlyLabelName1, gui_getPlayerName(PLAYER1));
        lv_label_set_text(ui_NPlyLabelName2, gui_getPlayerName(PLAYER2));
...
static void ui_event_BBallAction(lv_event_t* e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_MISS : P2_MISS);
        }
        else if (ui_BButtonRed == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_RED : P2_RED);
        }
        else if (ui_BButtonBlack == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_BLACK : P2_BLACK);
        }
        else if (ui_BButtonPink == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_PINK : P2_PINK);
        }
        else if (ui_BButtonBlue == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_BLUE : P2_BLUE);
        }
        else if (ui_BButtonBrown == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_BROWN : P2_BROWN);
        }
        else if (ui_BButtonGreen == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_GREEN : P2_GREEN);
        }
        else if (ui_BButtonYellow == target)
        {
            ...
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_YELLOW : P2_YELLOW);
        }
        else if (ui_BButtonRedF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_RED : P2_F_RED);
        }
        else if (ui_BButtonPinkF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_PINK : P2_F_PINK);
        }
        else if (ui_BButtonBlueF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_BLUE : P2_F_BLUE);
        }
        else if (ui_BButtonBrownF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_BROWN : P2_F_BROWN);
        }
        else if (ui_BButtonGreenF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_GREEN : P2_F_GREEN);
        }
        else if (ui_BButtonYellowF == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_F_YELLOW : P2_F_YELLOW);
        }
        else if (ui_BButtonF4 == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_FOUL_4 : P2_FOUL_4);
        }
        else if (ui_BButtonF5 == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_FOUL_5 : P2_FOUL_5);
        }
        else if (ui_BButtonF6 == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_FOUL_6 : P2_FOUL_6);
        }
        else if (ui_BButtonF7 == target)
        {
            gui_snooker_pushAction(activePlayer == PLAYER1 ? P1_FOUL_7 : P2_FOUL_7);
        }
...
static void ui_ScreenSnooker_screen_init(void)
{
    ...
    lv_obj_set_style_bg_image_src(ui_ScreenSnooker, &ui_img_snooker_table_480x320_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_NPlyLabelMaxScore1, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_USER_1);
    lv_obj_set_style_text_opa(ui_NPlyLabelMaxScore1, 255, LV_PART_MAIN | LV_STATE_USER_1);
...
//  lv_label_set_recolor(ui_NLabelPlyBreak, "true");
    ...
    lv_obj_set_style_text_color(ui_NPlyLabelMaxScore2, lv_color_hex(0xFF0000), LV_PART_MAIN | LV_STATE_USER_1);
    lv_obj_set_style_text_opa(ui_NPlyLabelMaxScore2, 255, LV_PART_MAIN | LV_STATE_USER_1);
    ...
    lv_label_set_text(ui_BLabel0, "miss");
    lv_obj_set_style_text_color(ui_BLabel0, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_BLabel0, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_MBPanelSnookerReset, lv_pct(100));
    lv_obj_set_height(ui_MBPanelSnookerReset, lv_pct(100));
    ...
    lv_obj_set_y(ui_MBLabelSnookerResetQ, 80);
    ...
    lv_obj_set_width(ui_MBPanelSnookerYellow, lv_pct(100));
    lv_obj_set_height(ui_MBPanelSnookerYellow, lv_pct(100));
    ...
    lv_obj_set_y(ui_MBLabelSnookerYellowQ, 80);
	...
	ui_NameKeyboard = ui_NameKeyboard_create(ui_ScreenSnooker);
