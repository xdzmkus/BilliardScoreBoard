...
static void ui_event_onBallsControlUpdate(lv_event_t* e)
{
    lv_event_code_t event_code = lv_event_get_code(e);
    ...
    if (event_code == LV_EVENT_VALUE_CHANGED)
    {
        gui_snooker_setControl(lv_obj_has_state(target, LV_STATE_CHECKED));
    }
}
...
void gui_settings_init()
{
    ...
    // Snooker
    lv_obj_add_event_cb(ui_SSwitchControl, ui_event_onBallsControlUpdate, LV_EVENT_ALL, NULL);
