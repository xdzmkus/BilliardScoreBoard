...
#define SAY_BYE 1001
#define SAY_GAME 1002
#define SAY_FRAME 1003
#define SAY_MIN -255
#define SAY_MAX 255
...
static void playMP3(const char* filename)
{
    ...
    AudioOutputI2S out(0, AudioOutputI2S::INTERNAL_DAC);
...
{
    MillisTimer waterMarkTimer(5000);
...
static void say(int16_t word)
{
    ...
    if (isAudio && QueueHandle && uxQueueSpacesAvailable(QueueHandle) > 0)
    {
