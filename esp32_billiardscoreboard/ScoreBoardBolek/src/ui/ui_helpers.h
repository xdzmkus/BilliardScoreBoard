...
#ifndef _SQUARELINE_POOL_UI_HELPERS_H
#define _SQUARELINE_POOL_UI_HELPERS_H
...
void _ui_screen_change(lv_obj_t * target, lv_scr_load_anim_t fademode, int spd, int delay, bool auto_del);
