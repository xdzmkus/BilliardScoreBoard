...
extern void saveEEPROMGreetingMsg();
...
lv_obj_t* ui_SLabelSettings;
lv_obj_t* ui_SPanelSnooker;
lv_obj_t* ui_SLabelSnooker;
lv_obj_t* ui_SLabelControl;
lv_obj_t* ui_SSwitchControl;
...
static void ui_event_onLabelHome(lv_event_t* e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        _ui_screen_change(ui_ScreenMain, LV_SCR_LOAD_ANIM_NONE, 0, 0, false);
    }
}
...
static void ui_event_onLabelRefresh(lv_event_t* e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        lv_obj_add_state(ui_SSwitchControl, LV_STATE_CHECKED);
...
static void ui_event_onGreetingSave(lv_event_t* e)
{
    ...
    if (event_code == LV_EVENT_CLICKED)
    {
        ...
        strncpy(greeting, greetingMsg, 96);

        saveEEPROMGreetingMsg();
    }
}
...
static void ui_ScreenSettings_screen_init(void)
{
    ...
    lv_obj_set_x(ui_SPanelPlayers, 0);
    lv_obj_set_y(ui_SPanelPlayers, 1);
    ...
    lv_obj_set_height(ui_SPanelPly1, 50);
    ...
    lv_obj_set_width(ui_SButtonEditPly1, 45);
    lv_obj_set_height(ui_SButtonEditPly1, 45);
    ...
    lv_obj_set_height(ui_SPanelPly2, 50);
    ...
    lv_obj_set_width(ui_SButtonEditPly2, 45);
    lv_obj_set_height(ui_SButtonEditPly2, 45);
    ...
    lv_obj_set_height(ui_SPanelPly3, 50);
    ...
    lv_obj_set_width(ui_SButtonEditPly3, 45);
    lv_obj_set_height(ui_SButtonEditPly3, 45);
    ...
    ui_SLabelSettings = lv_label_create(ui_SPanelSettings);
    lv_obj_set_width(ui_SLabelSettings, lv_pct(100));
    lv_obj_set_height(ui_SLabelSettings, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_align(ui_SLabelSettings, LV_ALIGN_CENTER);
    lv_label_set_text(ui_SLabelSettings, "Настройки:");
    lv_obj_set_style_text_color(ui_SLabelSettings, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_SLabelSettings, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_SLabelSettings, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_SPanelSnooker = lv_obj_create(ui_SPanelSettings);
    lv_obj_set_height(ui_SPanelSnooker, 205);
    ...
    ui_SLabelControl = lv_label_create(ui_SPanelSnooker);
    lv_obj_set_width(ui_SLabelControl, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_SLabelControl, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_x(ui_SLabelControl, 0);
    lv_obj_set_y(ui_SLabelControl, 35);
    lv_label_set_text(ui_SLabelControl, "Контроль шаров");

    ui_SSwitchControl = lv_switch_create(ui_SPanelSnooker);
    lv_obj_set_width(ui_SSwitchControl, 50);
    lv_obj_set_height(ui_SSwitchControl, 25);
    lv_obj_set_x(ui_SSwitchControl, 0);
    lv_obj_set_y(ui_SSwitchControl, 40);
    lv_obj_set_align(ui_SSwitchControl, LV_ALIGN_TOP_RIGHT);
    lv_obj_add_state(ui_SSwitchControl, LV_STATE_CHECKED);     /// States

    lv_obj_set_style_bg_color(ui_SSwitchControl, lv_color_hex(0x105908), LV_PART_INDICATOR | LV_STATE_CHECKED);
    lv_obj_set_style_bg_opa(ui_SSwitchControl, 255, LV_PART_INDICATOR | LV_STATE_CHECKED);
    ...
    lv_obj_set_y(ui_SSwitch6Red, 80);
    ...
    lv_obj_set_x(ui_SLabelHandicap1, 1);
    lv_obj_set_y(ui_SLabelHandicap1, 117);
    lv_label_set_text(ui_SLabelHandicap1, "Гандикап");
    ...
    lv_obj_set_x(ui_STextAreaHandicap1, -130);
    ...
    lv_obj_set_x(ui_SLabelHandicap2, 250);
    lv_obj_set_y(ui_SLabelHandicap2, 130);
    lv_label_set_text(ui_SLabelHandicap2, ":");
    ...
    lv_obj_set_y(ui_STextAreaHandicap2, 120);
...
void gui_settings_create()
{
    ...
    lv_label_set_text(ui_SLabelGreeting, greeting);
